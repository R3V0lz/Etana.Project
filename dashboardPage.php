        ...
        <ul class="navbar-nav">
          <li class="navbar-brand dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end">
              <li><button onclick="document.location='./logout.php'" class="dropdown-item btn">Logout</button></li>
            </ul>
          </li>
        </ul>
      </div>
    ...
    <div class="row">
      ...
      <div class="col-sm-12 col-lg-2 sidebar d-flex flex-column">
        <button onclick="document.location='./dashboardPage.php'" type="button"
          ...
          style="background-color: #495057;">Dashboard</button>
        <button onclick="document.location='./reqPage.php'" type="button"
          class="border rounded-4 border-0 btn btn-dark sidebar-button">Request</button>
      </div>
      <div class="col-lg-10 main-content pt-5">
        <div class="row">
          <div class="col-sm-12 col-lg-6 sub-column">
            <h3>Pie Chart</h3>
            <div class="card border-0" id="pieChart"></div>
          </div>
          <div class="col-lg sub-column">
            <h3>Bar Chart</h3>
            <div class="card border-0" id="barChart"></div>
          </div>
        </div>
      </div>
    </div>
